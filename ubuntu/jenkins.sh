...
RELEASE=1.11.5 ./update-golang/update-golang.sh
mkdir -p ${USER_HOME}/workspace/go-apps
...
## Maven
cd /usr/local/src
curl -L -O http://www-us.apache.org/dist/maven/maven-3/3.5.4/binaries/apache-maven-3.5.4-bin.tar.gz
tar -xvzf apache-maven-3.5.4-bin.tar.gz
sudo mv apache-maven-3.5.4 /usr/local/maven

## Gradle
cd /usr/local/src
curl -O -L "https://services.gradle.org/distributions/gradle-4.7-bin.zip"
