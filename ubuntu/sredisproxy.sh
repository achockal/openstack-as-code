...
ORCA_SLAVE_IP=192.168.1.8
CLOUDDRIVER_SLAVE_IP=192.168.1.31

declare -A ip=( ["orca"]="$ORCA_SLAVE_IP" ["clouddriver"]="$CLOUDDRIVER_SLAVE_IP" )

# Beware. Hard-coded values. Make sure it syncs with the values in setup-stage.sh file
declare -A port=( ["orca"]="16381" ["clouddriver"]="16382" )
